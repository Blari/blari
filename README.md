...
**Full-stack software engineer · Applied AI & Infrastructure**  
...
I also handle **servers and DevOps**: self-managed infrastructure, Docker deployments, CI/CD pipelines, cloud migrations, and ongoing server maintenance.
...
**Backend:** REST APIs · WebSockets · Redis  
**DevOps & Servers:** Docker / Compose · GitHub Actions · CI/CD · AWS · GCP · Hetzner · Cherry Servers · Self-hosted infrastructure
